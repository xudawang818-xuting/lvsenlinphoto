            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
               ...
               <div className="lg:col-span-1 space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <label className={`flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded cursor-pointer hover:border-emerald-500 hover:bg-emerald-50 transition aspect-square ${isProcessingImg ? 'opacity-50 cursor-wait' : ''}`}>
                       {isProcessingImg ? (
